...
//!
//! 本模块处理 Agent Switch 统一 MCP 格式与 OpenCode 格式之间的转换。
//!
//! ## 格式差异
//!
//! | Agent Switch 统一格式    | OpenCode 格式       |
//! |----------------------|---------------------|
...
/// Convert Agent Switch unified format to OpenCode format
///
/// Conversion rules:
...
// ============================================================================
// Format Conversion: OpenCode → Agent Switch
// ============================================================================

/// Convert OpenCode format to Agent Switch unified format
///
/// Conversion rules:
