...
impl Database {
        ...
        let result = (|| {
            while version < SCHEMA_VERSION {
                match version {
                    ...
                    11 => {
                        log::info!("迁移数据库从 v11 到 v12（添加 Pi Skills 支持）");
    ...
    fn migrate_v2_to_v3(conn: &Connection) -> Result<(), AppError> {
        ...
        // 说明：v3 结构将 Skills 的 SSOT 迁移到 ~/.agentswitch/skills/，
    ...
    fn migrate_v11_to_v12(conn: &Connection) -> Result<(), AppError> {
        ...
        log::info!("v11 -> v12 迁移完成：已添加 Pi Skills 支持");
        Ok(())
    }
