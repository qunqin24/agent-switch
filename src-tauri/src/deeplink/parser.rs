...
//!
//! Parses agentswitch:// and legacy ccswitch:// URLs into DeepLinkImportRequest structures.
...
/// Parse an Agent Switch URL into a DeepLinkImportRequest.
///
/// Expected format:
...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "agentswitch" && scheme != "ccswitch" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'agentswitch' or legacy 'ccswitch', got '{scheme}'"
        )));
    }
