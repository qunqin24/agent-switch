...
AgentSwitch provides rich icon customization features:
...
This ensures AgentSwitch and CLI tool configurations stay in sync.
...
When adding a provider, AgentSwitch automatically extracts endpoint URLs from the configuration.
