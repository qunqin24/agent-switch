...
2. AgentSwitch updates the configuration file
...
1. Right-click the AgentSwitch icon in the system tray
...
When switching providers, AgentSwitch modifies the following files:
