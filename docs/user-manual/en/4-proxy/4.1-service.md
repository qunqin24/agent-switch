...
sequenceDiagram
    ...
    participant Proxy as Local Proxy (Agent Switch)
...
After starting the proxy and enabling app takeover, Agent Switch modifies app configurations:
...
When stopping the proxy, Agent Switch will:
