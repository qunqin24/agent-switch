...
AgentSwitch is a cross-platform desktop application designed for developers who use AI tools. It helps you centrally manage configurations for **Claude Code**, **Claude Desktop**, **Codex**, **Gemini CLI**, **OpenCode**, **OpenClaw**, and **Hermes**.
...
AgentSwitch solves these problems through a unified interface.
...
AgentSwitch is built with a modern technology stack:
