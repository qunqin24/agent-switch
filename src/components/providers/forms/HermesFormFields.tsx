  ...
  return (
    <>
      ...
      <ProviderFormSection
        sectionKey="models"
        icon={Layers}
        title={t("hermes.form.models", { defaultValue: "模型列表" })}
      ...
      >
        <ProviderFormSection
          ...
          title={t("hermes.form.providerAdvanced")}
          actions={
            <CollapsibleTrigger asChild>
              <Button
                type="button"
              ...
              >
                ...
                <span className="sr-only">
                  {t("hermes.form.providerAdvanced")}
                </span>
              </Button>
            </CollapsibleTrigger>
          }
          contentClassName={providerAdvancedOpen ? undefined : "hidden"}
        >
          <CollapsibleContent>
            <div className="space-y-1">
              <label className="text-xs text-muted-foreground">
