 ...
 * - `CodexOauthQuotaFooter`（agentswitch 自管 OAuth 路径，by ChatGPT account）
 */
export const SubscriptionQuotaView: React.FC<SubscriptionQuotaViewProps> = ({
  ...
  // ── inline 模式：保持单行，避免与供应商地址互相挤压换行 ──
  if (inline) {
    return (
      <div className="inline-flex flex-shrink-0 items-center gap-2 whitespace-nowrap text-xs">
