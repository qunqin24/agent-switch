...
This directory contains the Flatpak manifest (`com.agentswitch.desktop`) for AgentSwitch, used to convert the generated `.deb` artifact into an installable `.flatpak` package via CI or local builds.
