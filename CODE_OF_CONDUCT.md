...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported privately to the project maintainers through [GitHub Private Vulnerability Reporting](https://github.com/qwq202/agent-switch/security/advisories/new). All complaints will be reviewed and investigated promptly and fairly.
...
辱骂、骚扰或其他不可接受的行为可通过 [GitHub 私密漏洞报告](https://github.com/qwq202/agent-switch/security/advisories/new) 私下联系本项目维护者。所有投诉都将得到及时和公平的审查和调查。
